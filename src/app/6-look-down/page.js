...
export default function Page() {
  ...
  useEffect(() => {
    const messages = [
      ...
      { message: "HA HA HA HA HA HA HA!", duration: 1750, type: "angry" },
      { message: "YOU LITTLE PIECE OF-", duration: 2500, type: "angry" },
      { message: "I BELIEVED IN YOU!", duration: 3000, type: "angry" },
      { message: "And yet...", duration: 3000 },
      { message: "HOW CAN YOU-", duration: 2000, type: "angry" },
      ...
      {
        message: "The more i think, the more i get angry!",
        duration: 3000,
        type: "angry",
      },
      {
      ...
      { message: "Go all way DOWN to hell!", duration: 3000, type: "angry" },
    ];
